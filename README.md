...
現職VideoTouchでは、シニアエンジニアとしてバックエンドを中心にシステム開発に従事。
...
ドメインの異なるプロジェクトからプロジェクト、または不確実性の高いプロジェクトへのアサインが多いため、単に与えられた業務をこなすだけでなく、以下の点を常に心がけた。
...
人数の少ない徳島オフィスに在籍していることもあり、徳島オフィス固有の業務も多かった。
